...
const Genre = ({ genres, setGenre, selectedGenres, setSelect, setPage, type }) => {
  const classes = useStyles();

  const fetchGenre = async () => {
    const { data } = await Axios.get(`https://api.themoviedb.org/3/genre/${type}/list?api_key=e8a0d7a3e13318d239bbd79bb0a368d7&language=en-US`);
